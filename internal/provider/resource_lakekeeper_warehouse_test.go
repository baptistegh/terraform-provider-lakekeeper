		...
		Steps: []resource.TestStep{
			// Create a warehouse with S3 storage profile
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "protected", "false"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "active", "true"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "storage_profile.type", "adls"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "storage_profile.account_name", "testacc"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "storage_profile.filesystem", "testfs"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "storage_credential.type", "az_shared_access_key"),
					resource.TestCheckResourceAttr("lakekeeper_warehouse.gcs", "storage_credential.az_key", "test-key"),
				),
			},
		},
	})

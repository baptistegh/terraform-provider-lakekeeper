		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.6", "get_endpoint_statistics"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.7", "get_metadata"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.8", "include_in_list"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.9", "list_deleted_tabulars"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.10", "list_namespaces"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.11", "modify_storage"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.12", "modify_storage_credential"),
					resource.TestCheckResourceAttr("data.lakekeeper_warehouse_role_access.foo", "allowed_actions.13", "rename"),
				),
			},
		},
	})
